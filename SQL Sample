...
CREATE TABLE long_album as
  select c.title from albums as c, tracks as a, long as b where a.name = b.name and a.albumId = c.albumId;


-- Question 6
CREATE TABLE track_count as
  select albumId, count(name) FROM tracks GROUP BY albumId;
